...
<div class="container">
    <div class="page-title">
        <h3>Pelanggan
        <a href="/admin/customers/create" class="btn btn-sm btn-outline-primary float-end"><i class="fas fa-plus"></i> Tambah</a>
        </h3>
    </div>
    <?php if($edit): ?>
        <div class="card">
                ...
                <form accept-charset="utf-8" method="post" action="/admin/customers">
                    ...
                    <div class="row g-2">
                        <div class="mb-3 col-md-4">
                            <input type="text" name="firstname" class="form-control" placeholder="Nama Depan" value="<?= $customers[0]['firstname'] ?>">
                        </div>
                        <div class="mb-3 col-md-4">
                            <input type="text" name="lastname" class="form-control" placeholder="Nama Akhir" value="<?= $customers[0]['lastname'] ?>">
                        </div>
                        <div class="mb-3 col-md-4">
                            <input type="tel" name="phone" class="form-control" placeholder="Telepon" value="<?= $customers[0]['phone'] ?>">
                        </div>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" name="address" placeholder="Alamat" value="<?= $customers[0]['address'] ?>">
                    </div>
                    <div class="row g-2">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <form action="/admin/customers" method="post">
                                            ...
                                            <a href="/admin/delete-customer?id=<?= $customer['id']; ?>" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i></a>
                                        </form>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
