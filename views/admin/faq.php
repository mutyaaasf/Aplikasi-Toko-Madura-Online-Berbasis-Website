...
<div class="container">
    <div class="page-title">
        <h3>FAQ
        <a href="/admin/faq/create" class="btn btn-sm btn-outline-primary float-end"><i class="fas fa-plus"></i> Tambah</a>
        </h3>
    </div>
    <?php if($edit): ?>
        <div class="card">
            ...
            <div class="card-body">
                <form accept-charset="utf-8" method="post" action="/admin/faq">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="question" placeholder="Pertanyaan" class="form-control" value="<?= $data[0]['question'] ?>">
                    </div>
                    <div class="mb-3">
                        <textarea style="resize:none" name="answer" placeholder="Jawaban" class="form-control" rows="3"><?= $data[0]['answer'] ?></textarea>
                    </div>
                    <div class="mb-3">
