...
<div class="container">
    <div class="row">
        <div class="card">
            <div class="card-header">Buat FAQ</div>
            <div class="card-body">
                <form accept-charset="utf-8" method="post" action="/admin/faq/create">
                    <?php CSRF::csrfInputField() ?>
                    <div class="mb-3">
                        <label class="form-label">Pertanyaan</label>
                        <input type="text" name="question" placeholder="Pertanyaan" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <textarea style="resize:none" type="text" name="answer" placeholder="Jawaban" class="form-control" rows="3" required></textarea>
                    </div>
                    <div class="mb-3">
