    ...
    <div class="wrapper">
        <nav id="sidebar" class="active">
            <ul class="list-unstyled components text-secondary">
                ...
                <li>
                    <a href="/admin/products"><i class="fas fa-shopping-cart"></i>Produk</a>
                </li>
                <li>
                    <a href="/admin/categories"><i class="fas fa-file"></i>Kategori</a>
                </li>
                <li>
                    <a href="/admin/customers"><i class="fas fa-user"></i></i>Pelanggan</a>
                </li>
                <li>
                    <a href="/admin/staff"><i class="fas fa-user"></i></i>Staff</a>
                </li>
                <li>
                    <a href="/admin/suppliers"><i class="fas fa-user"></i></i>Supplier</a>
                </li>
                <li>
                    <a href="/admin/orders"><i class="fas fa-file"></i>Pesanan</a>
                </li>
                <li>
                    <a href="/admin/faq"><i class="fas fa-info-circle"></i>Faq</a>
                </li>
                <li>
                    <a href="/admin/settings"><i class="fas fa-cog"></i>Pengaturan</a>
                </li>
            </ul>
        </nav>
                        ...
                        <li class="nav-item dropdown">
                            <div class="nav-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end nav-link-menu">
                                    <ul class="nav-list">
                                        <li><a href="/admin/reset-password" class="dropdown-item"><i class="fas fa-address-card"></i> Reset Kata Sandi</a></li>
                                        <li><a href="/admin/logout" class="dropdown-item"><i class="fas fa-sign-out-alt"></i> Keluar</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
