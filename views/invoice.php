...
$dates = isset($_SESSION['dates']) ? $_SESSION['dates'] : '';

function generateInvoice($date, $pdo){
            ...
            <div class=\"invoice-box\">
                <table>
                    ...
                    foreach($_SESSION['cart'] as $item) {
                        ...
                        $invoice .= "<td>Rp" . number_format($item['price'] * $item['quantity'], 2) . "</td>";
                        $invoice .= "</tr>";
                        $total += $item['price'] * $item['quantity'];

                        // Kurangi stok dari database
                        // Misalnya, Anda memiliki tabel `products` dengan kolom `stock`
                        // Sesuaikan dengan struktur tabel Anda
                        $productId = $item['id'];
                        $quantity = $item['quantity'];
                        // Tambahkan kueri untuk mengurangi stok
    ...
    <script>
        ...
        }, 1000); // Delay 1 detik untuk memberi waktu pencetakan
    </script>
    ";
